...
\begin{center}
	...
	\endfirsthead
	\\
	RO. 1 & \textit{Organizational intentions transparency}  \label{ro1} \\
	\\[-1.5ex]
	RO. 2 & \textit{Organizational intention resource-based cost estimation}  \label{ro2} \\
	\\[-1.5ex]
	RO. 3 & \textit{Organizational intention achievability estimation} \label{ro3}\\
	\\[-1.5ex]
	RO. 4 & \textit{Intention oriented working style}  \label{ro4}\\
	\\[-1.5ex]
	RO. 5 & \textit{Social organizational modeling}\label{ro5}\\
	\\[-1.5ex]
	RO. 6 & \textit{Re-use of organizational knowledge} \label{ro6}\\

...
The processes whose required activities and order of their execution cannot be determined beforehand are called \textit{Informal Processes} \cite{Sungur2014}. These type of processes are human-centric as their dynamic nature is due to the involvement of human knowledge. These processes are vitally important for production organization and they need to be supported and automated \cite{Sungur2015b}. This thesis work helps in realizing organizational modeling oriented to intention. The next section provides a detailed motivational statement of this master thesis work followed by a problem statement section which is then followed by contributions of this work. The final section provides an outline about the following chapters of the document. 

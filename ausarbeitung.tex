...
\input{content/MotivatingScenario}
\input{content/Fundamentals}
\input{content/Requirements}
\input{content/IntentionOrientedOrganizationalModeling}
\input{content/IntentionOrientedOrganizationalModelingNotation}
...
\ifdeutsch
All links were last followed on March 15, 2016.
\else
